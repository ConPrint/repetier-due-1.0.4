...
// X_MIN_2_PIN and others are used to provide GND for endstops
#define X_MIN2_PIN 35
#define X_MAX2_PIN 33
#define Y_MIN2_PIN 31
#define Y_MAX2_PIN 23
#define Z_MIN2_PIN 27
#define Z_MAX2_PIN 25

#define ENDSTOP_COMMON_LEVEL 0

#define MB_SETUP \
    SET_OUTPUT(X_MIN2_PIN); \
    WRITE(X_MIN2_PIN, ENDSTOP_COMMON_LEVEL); \
    SET_OUTPUT(X_MAX2_PIN); \
    WRITE(X_MAX2_PIN, ENDSTOP_COMMON_LEVEL); \
    SET_OUTPUT(Y_MIN2_PIN); \
    WRITE(Y_MIN2_PIN, ENDSTOP_COMMON_LEVEL); \
    SET_OUTPUT(Y_MAX2_PIN); \
    WRITE(Y_MAX2_PIN, ENDSTOP_COMMON_LEVEL); \
    SET_OUTPUT(Z_MIN2_PIN); \
    WRITE(Z_MIN2_PIN, ENDSTOP_COMMON_LEVEL); \
    SET_OUTPUT(Z_MAX2_PIN); \
    WRITE(Z_MAX2_PIN, ENDSTOP_COMMON_LEVEL);
